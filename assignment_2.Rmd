...
```{r Fig 1 ContinentPop, echo = TRUE, eval = TRUE, fig.align='center', fig.cap="Figure 1: Column chart comparing population growth across continents from 1950 to 2020.", out.width= "80%", message = FALSE, warning = FALSE,}
...
ggplot(Continent_data, aes(x = Year, y = Population, color = Entity)) +
  ...
  labs(
    title = "Continental population growth from 1950-2020",
    x = "Year", 
    y = "Population",
  ) + 
  theme(
...
```{r Table 1 Continent-summary, echo = TRUE, eval = TRUE, message = FALSE, warning = FALSE}
...
continent_TabData <- Continent_data %>%
  ...
  mutate(
    ...
    "Population 2020" = label_number(scale = 1e-6, suffic = "M", accurage = 0.1)(`Population 2020`),
...
```{r Fig 2 EconomicPop, echo = TRUE, eval = TRUE, fig.align='center', fig.cap="Figure 2: Area chart illustrating population growth trends across economic regions and age groups.", out.width= "80%", message = FALSE, warning = FALSE,}
...
```{r Table 2 SocioEco, echo = TRUE, eval = TRUE, message = FALSE, warning = FALSE}
