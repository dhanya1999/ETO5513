...
Figure \@ref(fig:ContinentPlot) presents a column graph that tracks the population changes across continents from 1950 to 2023. The data reveals several key trends such as Africa having the highest rate of population growth in this period and Europe the lowest. Other notable observations from \@ref(fig:ContinentPlot) include alarming population size in Asia exceeding 4.5 billion. 

Table \@ref(tab:Continent-summary) confirms Africas largest rate of population growth calculated as AGR at `r continent_TabData[continent_TabData$Entity == "Africa (UN)", "Annual Growth Rate"]`. Additionaly, \@ref(tab:Continent-summary) highlights that in 1950 and 2020 the percentage of Africa's population that is 65 or older is `r continent_TabData[continent_TabData$Entity == "Africa (UN)", "Percentage Population Aged 65+ in 1950"]` & `r continent_TabData[continent_TabData$Entity == "Africa (UN)", "Percentage Population Aged 65+ in 2020"]` respectively. Asia has also only experienced 5%  increase of the population aged 65+, with most other continents have had a large increase in percentage of population 65 years and older from 1950 to 2020 indicating increases in life expectancy in those regions. All continents have experienced a reduction in percentages of population aged between 0-14 years old. As populations have also increased in each continent this indicates that there is a large increase in working age population and 65+. As mentioned in (Lutz and KC, 2010) with increasing education has also come increased life expectancy, which will have major global implications for food, health, climate change and much more. 
