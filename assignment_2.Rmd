...
Economic_pop_percentages <- Economic_Popdata_wide1 %>% 
  ...
  mutate(
    `0-14` = round(`0-14`, 2),  # Round the percentage to 2 decimal places
    `15-64` = round(`15-64`, 2), # Round the percentage to 2 decimal places
    `65+` = round(`65+`, 2)      # Round the percentage to 2 decimal places
  ) %>% 
  mutate(
    `0-14` = paste0(`0-14`, "%"),  # Convert to string and add "%" sign
    `15-64` = paste0(`15-64`, "%"), # Convert to string and add "%" sign
    `65+` = paste0(`65+`, "%")      # Convert to string and add "%" sign
  ) %>% 
