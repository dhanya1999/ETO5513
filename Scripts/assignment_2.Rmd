...
#
# Visualize the gender gap for STEM and non-STEM Vocations using a box plot using "geom_boxplot".
#
ggplot(rn2, aes(x = STEM_Status, y = Gender_Gap, fill = STEM_Status)) +
  ...
  geom_text(
    ...
    hjust = 1.2, vjust = 2.0, color = "orange", size = 4
  ) +
  geom_text(
    data = iqr_stats, 
    aes(x = STEM_Status, y = Q3, label = paste("Q3:", round(Q3, 2))),
    hjust = 1.5, vjust = -1.1, color = "orange", size = 4
  ) +
  ...
  geom_label(data = summary_stats, 
             ...
             color = "red", size = 4, label.padding = unit(0.5, "lines"), label.size = 0.5, 
  ...
  geom_label(data = summary_stats, 
             ...
             color = "red", size = 4, label.padding = unit(0.5, "lines"), label.size = 0.5, 
             vjust = 2.0, hjust = -0.2, fill = "white") +  # White background for the call out label.
...
ggplot(australia_data, aes(x = Fld, y = Gender_Gap, fill = Edctn_lvl)) +
  ...
  scale_fill_brewer(palette = "Set1") + # Distinct colors for education levels
  ...
  annotate(
    "text", 
    x = 3, y = 9, # Adjust the x and y positions as needed
...
# kableExtra options:
#    position = "center", the table will be horizontally centre-aligned within the available space.
...
# the previous kable step used to left-align (align="l") the Fld text, which was globally applied. Also, the rows 5, 8, 9, 10 are italic and large 
...
# 
# caption <- tags$div(
#   tags$strong("Gender Gap Data for STEM Fields"),
#   style = "text-align: center; margin-bottom: 10px;"
# )
# 
# html_table <- australia_tab %>%
#   kable(
#     format = "html",
#     col.names = c("Field", "Level", "STEM Status", "Gender Gap"),
#     align = "lccc"
#   ) %>%
#   kable_styling(
#     bootstrap_options = c("striped", "hover", "condensed"),
...
# 
# browsable(tagList(caption, html_table))
```
